        ...
        <section class="slideshow">
          ...
          <div class="thumbnails-slider">
            <vueper-slides
              ...
              :visible-slides="gig.images.length"
              :fixed-height="'90px'"
              :fixed-width="'90px'"
              :bullets="false"
              :touchable="false"
    ...
    <section class="order-main">
      <aside class="aside">
        <section class="main">
          ...
          <p
            class="description"
          >I will active daily 10-14 hours, welcome new members, pin post create, delete spam messages</p>
