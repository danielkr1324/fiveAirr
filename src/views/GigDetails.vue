<template>
    <section class="main-container full">
        ...
        <section v-if="gig" class="details main-grid">
                    ...
                    <section class="slideshow">
                        ...
                        <div class="thumbnails-slider">
                            <vueper-slides class="no-shadow thumbnails" ref="vueperslides2"
                                ...
                                :visible-slides=gig.images.length :fixed-height="'90px'" :fixed-width="'90px'"
                                :bullets="false" :touchable="false" :gap="1" :arrows="false">
            ...
            <LoginSignup v-show="showLoginModal" :type="'login'" @closeModal="closeModal" />
        </section>
    </section>
</template>
